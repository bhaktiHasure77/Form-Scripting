...
(function (BH) {
    class ProjectFormLibrary {
         ...
         */
        static handleProjectLogic(context) {
            const formContext = context.getFormContext();
            ...
            const deadlineAttr = formContext.getAttribute("bh_projectdeadline");
            // Deadline Alert
            ...
            const completionControl = formContext.getControl("bh_completionpercentage");
    ...
    BH.ProjectFormLibrary = ProjectFormLibrary;
})(BH || (BH = {}));
window.BH = BH;
